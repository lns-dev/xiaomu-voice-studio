    ...
    for raw_line in sys.stdin:
        ...
        try:
            ...
            if model is None:
                ...
                def tokenizer_on_cpu(cls, model_path, **kwargs):
                    kwargs["device_map"] = "cpu"
                    kwargs["dtype"] = torch.float32
                    kwargs.pop("attn_implementation", None)
                    return original_tokenizer_loader(cls, model_path, **kwargs)

                Qwen3TTSTokenizer.from_pretrained = classmethod(tokenizer_on_cpu)
                try:
                ...
                emit({"type": "progress", "id": command["id"], "stage": "model_ready", "percent": 45, "message": "音色设计引擎已加载"})
